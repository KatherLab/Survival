...
parser.add_argument('--datadir_train', type = str, default = r'I:\TCGA-CRC-DX\BLOCKS_NORM_MACENKO')
parser.add_argument('--slide_dir', type = str, default = "I:\TCGA-CRC-DX\TCGA-CRC-DX_SLIDE.csv")
parser.add_argument('--clini_dir', type = str, default = "I:\TCGA-CRC-DX\TCGA-CRC-DX_CLINI.xlsx")
parser.add_argument('--folds', type = int, default = 3)
parser.add_argument('--outputPath', type = str, default = r"G:\Survival_TCGA_CRC_FullCohort_GeneralDeath_NEW")
parser.add_argument('--checkPointName', type = str, default = r'ckpt_TCGA_CRC_NEW')
...
parser.add_argument('--maxBlockNum', type = int, default ="256")
parser.add_argument('--gpuNo', type = int, default = 1)

parser.add_argument('--evenCol', type = str, default = "STATUS")
parser.add_argument('--timeCol', type = str, default = "FUDAYS")
...
if __name__ == '__main__':
    ...
    #cleanedTable = cleanedTable[0:10]
